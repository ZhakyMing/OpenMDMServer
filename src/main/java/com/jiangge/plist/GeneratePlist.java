...
public class GeneratePlist {
	public static void main(String[] args) throws Exception {
		URL dirUrl = GeneratePlist.class.getResource(".");
		...
		GeneratePlist test = new GeneratePlist();
	...
	private PrivateKey extractPrivateKey(String path2keystore)
		...
		caKs.load(new FileInputStream(new File(path2keystore)), password
				.toCharArray());
	...
	private void generatePlist(String csr, String chain, String signature)
			throws IOException {
		Document document = DocumentHelper.createDocument();
		document.addDocType("plist", "-//Apple//DTD PLIST 1.0//EN",
