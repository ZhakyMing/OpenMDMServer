...
<div class="main1">
  ...
  <tr>
    ...
    <div class="right1"> 
      <div class="top"><span>APP信息&nbsp;[<a href="${sysadmin_ctx }/installAppInput.do?deviceId=${device.deviceId }" target="rightFrame" style="color: #4285F4;font-size: 14px;">刷新</a>] <a href="${sysadmin_ctx }/deviceList.do" target="rightFrame" style="color: #4285F4;font-size: 14px;">&lt;&lt;返回</a></span></div>
      ...
      <table width="100%" border="0" cellspacing="10">
          ...
          <tr><td width="110" height="14" align="right">输入值：</td><td><input type="text" id="cvalue" name="cvalue" value="" style="width: 400px; height: 22px;"/></td></tr>
          <tr><td width="110" height="14" align="right"><input type="button" onclick="installForm();" value="提交请求" style="width: 65px; height: 24px;" /></td><td>&nbsp;</td></tr>
      </table>
      </form>
    </div>
    <!--主题部分的左边-->
